  ...
  return createPortal(
    ...
    >
      <div
        ...
        tabIndex={-1}
        className="animate-pop-in flex h-[780px] max-h-full w-full max-w-[1040px] flex-col overflow-hidden rounded-[24px] border border-hairline/50 bg-panel shadow-2xl shadow-black/50 outline-none"
      >
